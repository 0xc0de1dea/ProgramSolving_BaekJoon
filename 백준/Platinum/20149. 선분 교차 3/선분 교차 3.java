...
public class Main {
    ...
    public static void main(String[] argu) throws Exception {
        ...
        int result = lineSegmentIntersection(lines[0], lines[1]);
        sb.append(result > 0 ? 1 : 0).append('\n');
        double[] meetPoint = new double[2];

        if (result >= 1 && result <= 3){
            meetPoint = getMeetPoint(lines[0], lines[1], result);
            sb.append(meetPoint[0]).append(' ').append(meetPoint[1]);
        }
