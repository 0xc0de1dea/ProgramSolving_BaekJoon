...
public class Main {
    ...
    public static void main(String[] argu) throws Exception {
        ...
        while (t-- > 0){
            ...
            lines[0] = new Line(new Point(xmin, ymin), new Point(xmin, ymax));
            lines[1] = new Line(new Point(xmin, ymin), new Point(xmax, ymin));
            lines[2] = new Line(new Point(xmin, ymax), new Point(xmax, ymax));
            lines[3] = new Line(new Point(xmax, ymin), new Point(xmax, ymax));
            lines[4] = new Line(new Point(in.nextInt(), in.nextInt()), new Point(in.nextInt(), in.nextInt()));

            int cnt = 0;

            for (int i = 0; i < 4; i++){
                int result = lineSegmentIntersection(lines[4], lines[i]);
