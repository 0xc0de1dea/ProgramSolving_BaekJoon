...
public class Main {
    ...
    static long n;
    static final long MMOD = 1_000_000_000L;
    static final long MOD = 100_000_000L;

    static long f(long x, long m, int depth){
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (res >= MOD){
            sb.append(String.format("%08d", res % MOD)).append('\n');
        } else {
            sb.append(String.format("%d", res % MOD)).append('\n');
        }
