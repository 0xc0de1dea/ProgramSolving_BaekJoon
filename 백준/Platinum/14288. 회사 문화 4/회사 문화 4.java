...
public class Main {
    ...
    public static void main(String args[]) throws Exception {
        ...
        FenwickTree fwTree1 = new FenwickTree(n + 1);
        FenwickTree fwTree2 = new FenwickTree(n + 1);
        dfs(1);
        int dir = 1;
        ...
        while (m-- > 0){
            ...
            if (query == 1){
                ...
                if (dir == 1) fwTree1.update(inner[i], outer[i] + 1, w);
                else fwTree2.update(inner[i], w);
            }
            else if (query == 2){
                int i = in.nextInt();
                sb.append(fwTree1.sum(inner[i]) + fwTree2.sum(outer[i]) - fwTree2.sum(inner[i] - 1)).append('\n');
            }
            else {
                dir *= -1;
            }
